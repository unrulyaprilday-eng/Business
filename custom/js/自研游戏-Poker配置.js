(function () {
  ...
  function renderFields(game) {
    return [
      ...
      "</tbody></table>",
      "</section>",
      "<section class=\"self-game-config-section\"><h3>机器人与房间运行规则</h3><p>仅有房间的游戏支持机器人设置。机器人数量按桌子顺序填写，使用英文逗号分隔。</p><table class=\"self-game-data-table self-game-room-table self-game-room-robot-table\"><thead><tr><th>房间</th><th>进入桌子数量</th><th>进入桌子人数限制</th><th>桌子机器人最大数量限制</th><th>机器人数量</th></tr></thead><tbody>",
