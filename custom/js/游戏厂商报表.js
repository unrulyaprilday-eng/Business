(function () {
  var rows = [
    ['568WIN-USD', 'DG', 'DreamGaming', '视讯', '2', '3', '1,650.00', '800.00', '850.00', '48.48%'],
    ['568WIN-USD', 'SA', 'SaGaming', '视讯', '2', '3', '34.00', '20.00', '14.00', '58.82%'],
    ['AE', 'SPRIBE', 'Spribe', '区块链', '9', '112', '3,850.00', '3,341.20', '508.80', '86.78%'],
    ['HG-USD', 'JILI', 'JILI Games', '捕鱼', '14', '1,185', '4,317,802.80', '4,814,046.60', '-496,243.80', '111.49%'],
    ['HG-USD', 'TADA', 'Tada Gaming', '电子', '22', '1,492', '92,640.00', '88,240.00', '4,400.00', '95.25%'],
    ['HG-USD', 'PG', 'PG Soft', '电子', '18', '872', '68,500.00', '71,830.00', '-3,330.00', '104.86%'],
    ['568WIN-USD', 'EVO', 'Evolution', '视讯', '7', '223', '28,900.00', '24,630.00', '4,270.00', '85.22%'],
    ['AE', 'KINGMAKER', 'Kingmaker', '棋牌', '5', '146', '12,420.00', '11,088.00', '1,332.00', '89.28%'],
    ['HG-USD', 'CQ9', 'CQ9', '电子', '11', '764', '54,260.00', '48,902.00', '5,358.00', '90.13%'],
    ['568WIN-USD', 'SBO', 'SBO Sports', '体育', '6', '95', '36,800.00', '39,120.00', '-2,320.00', '106.30%'],
    ['AE', 'FC', 'Fa Chai', '电子', '16', '538', '42,710.00', '37,526.00', '5,184.00', '87.86%'],
    ['HG-USD', 'PP', 'Pragmatic Play', '电子', '20', '918', '83,360.00', '76,188.00', '7,172.00', '91.40%']
  ];
  ...
  function render() {
    ...
    base.innerHTML = [
      ...
      '<thead><tr>',
      '<th>商户币种</th><th>厂商编码</th><th>厂商名称</th><th>游戏类型</th><th>游戏数量</th><th>投注总次数</th><th>投注总金额</th><th>总派彩</th><th>总损益</th><th>RTP</th>',
      '</tr></thead>',
      '<tbody>',
